/**
 * ADR-0020 C3-3: 昨日の Mastery から翌日の一手を決める。
 * stuck → ずかん / partial・未回答 → きょうのしょ再問 / clear・parked は他の導線へ譲る。
 */

import { dateKeyJST } from "@/lib/date";
import { isMasteryState, type MasteryState } from "@/lib/daily-textbook";
